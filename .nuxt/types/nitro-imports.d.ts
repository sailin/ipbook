declare global {
  ...
  const getAuthCookie: typeof import('../../server/utils/auth').getAuthCookie
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from '/home/hangjin/workspace/ipbook/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from '/home/hangjin/workspace/ipbook/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { hashPassword, verifyPassword, signToken, verifyToken, setAuthCookie, clearAuthCookie, getAuthCookie, getAuthUser, requireAuth } from '/home/hangjin/workspace/ipbook/server/utils/auth';